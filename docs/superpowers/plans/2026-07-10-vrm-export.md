...
```bash
"C:\Program Files\Blender Foundation\Blender 5.1\blender.exe" --background --python "C:\Users\PC_User\Documents\ar-avatar-demo\scripts\export_vrm.py" 2>&1 | tail -20
```
